...
emoji: "🇺🇸",
  ...
  {
    id: "andaman-series",
    title: "Andaman Islands Travel Series",
    description: "A journey through the Andaman Islands - Port Blair, Havelock, Neil Island",
    emoji: "🇮🇳",
  },
  {
    id: "Portugal-series",
  ...
  {
    id: "andalusia-spain-series",
    title: "Andalusia Travel Series",
    description: "A journey through Andalusia - Seville, Cordoba,Granada, Ronda & Setenil de las Bodegas",
    emoji: "🇪🇸",
  },
...
export const videos: Video[] = [
  ...
  },
  {
    ...
    // Andaman Islands Series
    {
        id: "GzLPF_ICZpQ",
        title: "Andaman 7 Days Itinerary",
        description: "Andaman 7 Days Itinerary - Port Blair, Havelock, Neil Island",
        category: "Travel Film",
        url: "https://youtu.be/GzLPF_ICZpQ",
        tags: ["andaman", "islands", "port-blair", "havelock", "neil-island", "cinematic"],
        relatedBlog: "week-in-andaman",
        playlist: "andaman-series",
    },
    {
      id: "rZm94KGVzbI",
      title: "Port Blair - Must See Places",
      description: "Port Blair - Must See Places - Cellular Jail, Ross Island etc",
      category: "Travel Film",
      url: "https://youtu.be/rZm94KGVzbI",
      tags: ["andaman", "islands", "port-blair", "cellular-jail", "ross-island", "cinematic"],
      relatedBlog: "week-in-andaman",
      playlist: "andaman-series",
    },
    {
      ...
      description: "Experience Jolly Buoy Island",
      category: "Travel Film",
      url: "https://youtu.be/29ssRTHAKqM",
      tags: ["andaman", "islands", "jolly-buoy", "cinematic"],
      relatedBlog: "week-in-andaman",
      playlist: "andaman-series",
    },
    { 
      id: "gCIXEEhD_Yo",
      title: "Havelock Island - Must See Places",
      description: "Havelock or Swaraj Island - Must See Places - Kalapathar Beach, Radhanagar Beach etc",
      category: "Travel Film",
      url: "https://youtu.be/gCIXEEhD_Yo",
      tags: ["andaman", "islands", "havelock", "swaraj-island", "kalapathar-beach", "radhanagar-beach", "cinematic"],
      relatedBlog: "week-in-andaman",
      playlist: "andaman-series",
    },  
    {
      id: "9aowT6nM7rE",
      title: "Neil Island - Must See Places",
      description: "Neil Island or Shaheed Dweep - Must See Places",
      category: "Travel Film",
      url: "https://youtu.be/9aowT6nM7rE",
      tags: ["andaman", "islands", "neil-island", "shaheed-dweep", "bharatpur-beach", "cinematic"],
      relatedBlog: "week-in-andaman",
      playlist: "andaman-series",
    },
    {
      id: "anjlK1mS0pQ",
      title: "Andaman Top 15 Places to Visit",
      description: "Andaman Top 15 Places to Visit - Port Blair, Havelock, Neil Island",
      category: "Travel Film",
      url: "https://youtu.be/anjlK1mS0pQ",    
      tags: ["andaman", "islands", "port-blair", "havelock", "neil-island", "cinematic"],
      relatedBlog: "week-in-andaman",
      playlist: "andaman-series",
    },
     // Andalusia Spain Series
     {
      id: "Td4Yvmd0T1g",
      title: "Seville, Spain - 2 Days in Spain's Most Beautiful City",
      description: "Seville, Spain - 2 Days in Spain's Most Beautiful City",
      category: "Travel Film",
      url: "https://youtu.be/Td4Yvmd0T1g",
      tags: ["andalusia", "spain", "seville", "cinematic"],
      relatedBlog: "7-days-andalusia-cinematic-journey",
      playlist: "andalusia-spain-series",
  },
  {
    id: "JyjAw6PthHI",
    title: "Things to do in Córdoba, Spain 🇪🇸",
    description: "Things to do in Córdoba, Spain 🇪🇸",
    category: "Travel Film",
    url: "https://youtu.be/JyjAw6PthHI",
    tags: ["andalusia", "spain", "cordoba", "cinematic"],
    relatedBlog: "7-days-andalusia-cinematic-journey",
    playlist: "andalusia-spain-series",
  },
  {
    id: "S-qG6ywtBx8",
    title: "Granada & The Alhambra - Spain's Most Iconic Castle",
    description: "Granada & The Alhambra - Spain's Most Iconic Castle",
    category: "Travel Film",
    url: "https://youtu.be/S-qG6ywtBx8",
    tags: ["andalusia", "spain", "granada", "alhambra", "cinematic"],
    relatedBlog: "7-days-andalusia-cinematic-journey",
    playlist: "andalusia-spain-series",
  },
  { 
    id: "Sz9_dvf8DG8",
    title: "Pueblo Blancos - Ronda & Setenil de las Bodegas",
    description: "Pueblo Blancos - Ronda & Setenil de las Bodegas",
    category: "Travel Film",
    url: "https://youtu.be/Sz9_dvf8DG8",
    tags: ["andalusia", "spain", "ronda", "setenil-de-las-bodegas", "cinematic"],
    relatedBlog: "7-days-andalusia-cinematic-journey",
    playlist: "andalusia-spain-series",
  },  
  {
    id: "lQj1AFTpbCA",
    title: "An Unforgetable Andalusia Trip",
    description: "An Unforgetable Andalusia Trip",
    category: "Travel Film",
    url: "https://youtu.be/lQj1AFTpbCA",
    tags: ["andalusia", "spain", "cinematic"],
    relatedBlog: "7-days-andalusia-cinematic-journey",
    playlist: "andalusia-spain-series",
  },
];
